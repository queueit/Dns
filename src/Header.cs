...
namespace Yamool.Net.DNS
{
    ...
    public class Header
    {
        ...
        {
            return this.SetBits(oldValue, position, length, blnValue ? (ushort)1 : (ushort)0);
        }
        ...
        public byte[] Data
        {
            get
            {
                ...
                data.AddRange(this.WriteShort(ID));
                data.AddRange(this.WriteShort(Flags));
                data.AddRange(this.WriteShort(QDCOUNT));
                data.AddRange(this.WriteShort(ANCOUNT));
                data.AddRange(this.WriteShort(NSCOUNT));
                data.AddRange(this.WriteShort(ARCOUNT));
                return data.ToArray();
            }
        }
